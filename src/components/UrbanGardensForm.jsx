...
import Modal from '../images/DonaHuertos/GraciasxDonar.png'
        ...
        <div className="form">
            <form onSubmit={saveData} className="form-container">
                ...
                <div className="items">
                    ...
                    <label className='lbl-form' htmlFor="meters">Metros de Terreno a Donar<span className='cat'>*</span></label>
                    <input
                        type="text"
                        placeholder="Ej: 5m²"
                        className="space"
                            ...
                            <div className="modal-content">
                                ...
                                <div className='ctn-modal'>
                                    ...
                                    <div className='margin-modal'>
                                        ...
                                        <p><strong>Te recordamos que las Donaciones de Huertos Urbanos no son  monetarias..</strong></p>
                                        <div className='rrss'>
