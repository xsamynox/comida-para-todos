    ...
    <section>
      <div className='section-distribution'>
        <div className='ctn-distribution'>
          ...
          <p><strong>El 65% de los recursos de la Fundación</strong> se destinan a los Restaurantes, los que se encargan de realizar las comidas, apadrinar  comunidades vunerables entregándoles capacitaciones, además de compartir buenas prácticas sobre alimentación saludable.
          <br />
