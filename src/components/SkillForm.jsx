...
import Modal from '../images/DonaHabilidad/GraciasxDonar.png'
        ...
        <div className="form">
            <form onSubmit={saveData} className="form-container">
                ...
                <div className="items">
                    ...
                    <label className='lbl-form' htmlFor="meters">Ingresa tu Habilidad<span className='cat'>*</span></label>
                    <input
                        type="text"
                            ...
                            <div className="modal-content">
                                ...
                                <div className='ctn-modal'>
                                    ...
                                    <div className='margin-modal'>
                                        ...
                                        <p><strong>Te recordamos que las Donaciones de compartir una Habilidad con nosotros no son  monetarias.</strong></p>
                                        <div className='rrss'>
