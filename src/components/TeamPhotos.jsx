        ...
        <div className='container-radio'>
          <div className='container-radio'>
            <div className='radio-btn-filter'>
              <input type="radio" name="filter-team" value="Todos" />
              <p className='p-radio-team'>Todos</p>
            </div>
            <div className='radio-btn-filter'>
              <input type="radio" name="filter-team" value="Directores" />
              <p className='p-radio-team'>Directores</p>
            </div>
            <div className='radio-btn-filter'>
              <input type="radio" name="filter-team" value="Coordinadores" />
              <p className='p-radio-team'>Coordinadores</p>
            </div>
            <div className='radio-btn-filter'>
              <input type="radio" name="filter-team" value="Consultores" />
